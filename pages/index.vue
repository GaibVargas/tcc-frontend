...
<template>
  <div class="page-content d-flex flex-column">
    <main class="tutorial-page pa-4 pa-md-8 flex-grow-1">
      <h1>Como usar?</h1>
      <p>
        A plataforma de
        ...
        clicar
        na atividade que você será redirecionado para a plataforma já registrado com suas informações e estará pronto
        para
      ...
      <p>Depois de salvar as mudanças você pode continuar configurando a atividade no Moodle selecionando a ferramenta
        que
